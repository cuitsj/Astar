...
#
# Generated by export_simulation on Wed May 18 20:19:50 +0800 2022
#
################################################################################
...
'-reset_run' switch to the './closeram8.sh' script.

./closeram8.sh -reset_run
...
./closeram8.sh -noclean_files

For more information on the script, please type './closeram8.sh -help'.
