...
#
# Generated by export_simulation on Thu May 19 10:47:59 +0800 2022
#
################################################################################
...
'-reset_run' switch to the './openram8.sh' script.

./openram8.sh -reset_run
...
./openram8.sh -noclean_files

For more information on the script, please type './openram8.sh -help'.
