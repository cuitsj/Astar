...
HD_PWD='G:/01Astar/Astar128x128/top_astargnps/top_astargnps.runs/closeram8_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log closeram8.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source closeram8.tcl
