...
HD_PWD='G:/01Astar/Astar128x128/top_astargnps/top_astargnps.runs/openram12_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log openram12.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source openram12.tcl
