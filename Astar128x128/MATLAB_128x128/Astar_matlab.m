...
child_nodes = child_nodes_cal(parent_node, map_read, closeList); %子节点搜索函数 
...
while flag   
    ...
    child_nodes = child_nodes_cal(parent_node, map_read, closeList); 
...
if map_read(child_node(1),child_node(2)) == 0
