...
HD_PWD='G:/01Astar/0basic_ram/top_astargnps/top_astargnps.runs/ila_astar_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log ila_astar.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source ila_astar.tcl
