...
reg [13:0] map_addra;//地图的RAM地址
//map-BRAM
reg map_en,map_wea,map_dina;
wire map_douta;

//状态1,15,17
reg [13:0]  parent_node[2:0];
reg [13:0] close_row;//closelist的行数
reg [13:0] min_f;
//closelist-BRAM
reg close_ena,close_wea;
reg [13:0] close_addra;
reg [13:0] close_addr1;//地址计数
...
reg [13:0] openpy_addra,openpy_addrb;
reg [13:0] openpx_addra,openpx_addrb;
reg [13:0] opency_addra,opency_addrb;
reg [13:0] opencx_addra,opencx_addrb;
reg [13:0] openg1_addra,openg1_addrb;
reg [13:0] openg2_addra,openg2_addrb;
reg [13:0] openh_addra,openh_addrb;
reg [13:0] openf_addra,openf_addrb;
...
reg [13:0] openg1_dina,openg1_dinb;
reg [13:0] openg2_dina,openg2_dinb;
reg [13:0] openh_dina,openh_dinb;
reg [13:0] openf_dina,openf_dinb;
...
wire [13:0] openg1_douta,openg1_doutb;
wire [13:0] openg2_douta,openg2_doutb;
wire [13:0] openh_douta,openh_doutb;
wire [13:0] openf_douta,openf_doutb;
...
reg [13:0] open_row;//openlist的总行数
reg [13:0] openreal_row;//openlist的真实行数
reg [13:0] open_addr1;//用于判断子节点是否在openlist中计数
reg [13:0] open_addr2;//用于从openlist中找新的父节点计数行数
reg [13:0] open_addr3;//用于从openlist中回溯路径计数
